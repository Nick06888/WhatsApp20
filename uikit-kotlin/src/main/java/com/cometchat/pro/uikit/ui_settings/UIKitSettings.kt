    ...
    fun addConnectionListener(tag: String) {
        CometChat.addConnectionListener(tag, object : CometChat.ConnectionListener {
            override fun onConnected() {
                Toast.makeText(context, "Connesso", Toast.LENGTH_LONG).show()
            }

            override fun onConnecting() {
                Toast.makeText(context, "Connettendo...", Toast.LENGTH_LONG).show()
            }

            override fun onDisconnected() {
                Toast.makeText(context, "Disconnettendo...", Toast.LENGTH_LONG).show()
            }
